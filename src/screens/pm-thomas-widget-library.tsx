...
const WIDGETS: Widget[] = [
  ...
  { id:"w-019", name:"Next Best Action",             source:"AIMS OS — Intelligence",     skeleton:"Next Best Action",      category:"Intelligence",   health:"active", freshness:"live",  governed:true,  system:false, usedIn:6,  placement:"Company",    description:"AI-recommended next action for this account with confidence score and reasoning." },
