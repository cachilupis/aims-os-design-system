...
import { AdminMySettingsScreen }        from "./AdminMySettings"
import { AdminMyIntegrationsScreen }    from "./AdminMyIntegrations"

type PageId = "overview" | "people" | "studios" | "integrations" | "security" | "audit" | "billing" | "my-settings" | "my-integrations"

export function AdminConsoleScreen() {
  const [activePage, setActivePage] = useState<PageId>("overview")

  function navigate(id: string) {
    const valid: PageId[] = ["overview", "people", "studios", "integrations", "security", "audit", "billing", "my-settings", "my-integrations"]
  ...
  switch (activePage) {
    ...
    case "my-settings":      return <AdminMySettingsScreen        {...nav} />
    case "my-integrations":  return <AdminMyIntegrationsScreen    {...nav} />
  }
}
