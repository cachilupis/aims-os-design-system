        ...
        return (
          <button
            ...
            style={{
              ...
              background: isActive ? "var(--color-surface-primary-more-subtle)" : "var(--color-surface-neutral-white)",
              border: `1px solid ${isActive ? "var(--primary)" : "var(--color-border-neutral-default)"}`,
              borderRadius: "var(--radius-md)",
              cursor: "pointer",
    ...
    <div style={{ position: "relative", width: "100%" }}>
      <select
        ...
        style={{
          ...
          color: "var(--color-text-title)",
          background: "var(--color-surface-neutral-white)",
          border: "0.5px solid var(--color-border-neutral-default)",
          borderRadius: "var(--radius-md)",
          cursor: "pointer",
          fontFamily: "inherit",
        }}
